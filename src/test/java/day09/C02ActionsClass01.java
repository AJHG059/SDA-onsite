...
// Verify the texts that appear after the buttons are operated.
    ...
    public void test() {
        ...
        By doubleClackMassage = By.id("doubleClickMessage");
        By rightClickMessag = By.id("rightClickMessage");
        By dynamicClickMessag = By.id("dynamicClickMessage");

        //Go to URL: https://demoqa.com/buttons
        driver.get("https://demoqa.com/buttons");

        WebElement doubleClickE = driver.findElement(doubleClick);
        WebElement rightClickButtonE = driver.findElement(rightClickButton);
        ...
        actions
                ...
                .contextClick(rightClickButtonE)
                .click(clickE)
                .perform();
        ...
        Assert.assertTrue(driver.findElement(rightClickMessag).isDisplayed());
        Assert.assertTrue(driver.findElement(doubleClackMassage).isDisplayed());
        Assert.assertTrue(driver.findElement(dynamicClickMessag).isDisplayed());
